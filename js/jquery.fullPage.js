	...
	$.fn.fullpage = function(options) {
		...
		$('.section').each(function(index){
			...
			if (numSlides > 0) {
				...
				$(this).find('.controlArrow.next').css('border-color', 'transparent transparent transparent rgba(198, 61, 15, .5);');
				$(this).find('.controlArrow.prev').css('border-color', 'transparent rgba(198, 61, 15, .5); transparent transparent');
